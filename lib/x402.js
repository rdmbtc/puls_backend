...
export function x402Paywall(price, endpoint, opts = {}) {
  return async (req, res, next) => {
    ...
    const requirements = buildPaymentRequirements(price, payTo, ADVERTISED_MAX_TIMEOUT);
    ...
    const verifyRequirements = buildPaymentRequirements(price, payTo, VERIFY_MAX_TIMEOUT);
