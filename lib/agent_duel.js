...
export function registerAgentDuel(app, deps) {
  ...
  // Resolve a duel participant on whichever rail holds its funds:
  //   • Circle Agent Wallet (CIRCLE_AGENT_WALLETS) — balance via the CLI
  //   • dev-controlled SCA — balance via getWalletInfo
  // Returns null when no usable wallet exists at all.
